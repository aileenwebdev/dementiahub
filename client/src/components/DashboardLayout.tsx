        ...
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          <div className="flex flex-col items-center gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold tracking-tight">DementiaHub</h1>
                <p className="text-xs text-muted-foreground">Voice AI Portal</p>
              </div>
            </div>
            <p className="text-sm text-muted-foreground text-center max-w-sm mt-2">
              Secure access to your caregiver support portal. Sign in to manage calls and view your history.
            </p>
          </div>
          <Button
            onClick={() => {
              ...
              {!isCollapsed && (
                <div className="flex items-center gap-2 min-w-0">
                  ...
                  <div className="min-w-0">
                    <p className="text-sm font-semibold truncate leading-tight">DementiaHub</p>
                    <p className="text-[10px] text-muted-foreground truncate">Voice AI Portal</p>
                  </div>
                </div>
              )}
            </div>
        ...
        {isMobile && (
          <div className="flex border-b h-14 items-center justify-between bg-background/95 px-4 backdrop-blur supports-[backdrop-filter]:backdrop-blur sticky top-0 z-40">
            <div className="flex items-center gap-3">
              ...
              <span className="font-medium text-sm">{activeMenuItem?.label ?? "DementiaHub"}</span>
            </div>
          </div>
        )}
