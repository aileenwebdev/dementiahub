...
export const adminRouter = router({
  ...
  integration: adminProcedure.query(async () => {
    ...
    return {
      ...
      twilio: {
        configured: Boolean(config.twilioAccountSid && config.twilioAuthToken),
        accountSidConfigured: Boolean(config.twilioAccountSid),
        authTokenConfigured: Boolean(config.twilioAuthToken),
        phoneNumber: config.twilioPhoneNumber || null,
        whatsappNumber: config.twilioWhatsappNumber || null,
      ...
      webhooks: {
        ...
        twilioMessaging: `${config.appUrl}/api/webhooks/twilio/messaging`,
        twilioStatus: `${config.appUrl}/api/webhooks/twilio/status`,
        twilioVoice: `${config.appUrl}/api/webhooks/twilio/voice`,
        ...
        secretConfigured: {
          ...
          twilioSignature: Boolean(config.twilioAuthToken),
        },
      },
      failedSyncs,
    };
